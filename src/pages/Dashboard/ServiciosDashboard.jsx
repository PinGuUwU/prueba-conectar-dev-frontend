...
const ServiciosDashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        setServices(prevServices => Array.isArray(prevServices)
          ? prevServices.map(s => s._id === currentServiceId ? res.data.servicio : s)
          : [res.data.servicio] // Si no era array, reiniciamos con el nuevo
        );
        ...
        // Solo actualizamos si services es un array, sino lo inicializamos
        if (Array.isArray(services)) {
          setServices([...services, newServiceWithPopulate]);
        } else {
          setServices([newServiceWithPopulate]);
        }
  ...
  const handleDeleteService = async (serviceId) => {
    ...
    try {
      ...
      setServices(prevServices => Array.isArray(prevServices) ? prevServices.filter(s => s._id !== serviceId) : []);
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {serviceTypes && Array.isArray(serviceTypes) && serviceTypes.map(type => (
